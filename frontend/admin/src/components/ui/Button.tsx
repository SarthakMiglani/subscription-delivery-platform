...
export const Button = forwardRef<HTMLButtonElement, Props>(function Button(
  ...
  return (
    <button
      ...
      className={`focus-ring inline-flex items-center justify-center font-semibold transition-all duration-150 disabled:opacity-45 disabled:pointer-events-none active:scale-[0.98] whitespace-nowrap ${VARIANTS[variant]} ${SIZES[size]} ${fullWidth ? 'w-full' : ''} ${className}`}
      {...rest}
    >
